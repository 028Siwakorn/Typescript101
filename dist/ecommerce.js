...
//Create Object
const customer1 = new Customer("Mr. Siwakorn Kleebmek", "Nakhon Pathom");
...
//OrderDetails
const orderdetail1 = new OrderDetail(item1, 10, "not included");
const orderdetail2 = new OrderDetail(item2, 20, "not included");
const orderdetail3 = new OrderDetail(item3, 30, "not included");
//OrderDetail => Order
